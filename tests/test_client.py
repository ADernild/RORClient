...
Project: RORClient
Description: Unit tests for the RORClient synchronous client.
Date: 2025-02-17
"""
...
class TestRORClient(unittest.TestCase):
    ...
    def test_get_institution(self, mock_get):
        ...
        client = RORClient()
        institution = client.get_institution("03yrrjy16")
    ...
    def test_get_multiple_institutions(self, mock_get):
        ...
        client = RORClient()
        institutions = client.get_multiple_institutions(["03yrrjy16", "04y51qn38"])
